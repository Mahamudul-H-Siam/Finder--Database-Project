...
<div class="card">
    ...
    <h2>Book <?php echo htmlspecialchars($provider['ServiceType']); ?> from <?php echo htmlspecialchars($provider['BusinessName']); ?></h2>
    <div class="subtitle">Area: <?php echo htmlspecialchars($provider['Area']); ?> | Provider: <?php echo htmlspecialchars($provider['FullName']); ?></div>
