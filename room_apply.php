...
<head>
    ...
    <style>
        ...
        .form-group textarea { width:100%; padding:0.4rem 0.55rem; border-radius:0.6rem; border:1px solid #374151; background:#020617; color:#e5e7eb; font-size:0.85rem; outline:none; min-height:80px; resize:vertical; }
...
<div class="card">
    ...
    <div class="subtitle">Area: <?php echo htmlspecialchars($room['LocationArea']); ?> | Owner: <?php echo htmlspecialchars($room['OwnerName']); ?></div>
