...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$errors) {
        ...
        $stmt->bind_param(
            "issssdis",
            $ownerId, $listingType, $title, $desc, $area, $rent, $utilInc, $gender
        );
        if ($stmt->execute()) {
            $success = true;
        } else {
...
<div class="card">
    ...
    <form method="post">
        ...
        <div class="form-group">
            ...
            <textarea name="description" placeholder="Short details about the room, facilities, nearby places" required></textarea>
        </div>
